...
curl -H "Content-Type: application/json" -X PUT  --data '{"name":"导航模板样式", "templateId":1, "filename":"nav_tpl.html","content":"<div>__PageContent__</div>"}'  "${serverAddr}/api/wiki/models/website_template_style/new"
