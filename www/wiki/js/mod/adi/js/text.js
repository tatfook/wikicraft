define([
	...
	function getEditorParams(modParams) {
		...
		modParams.design.text = modParams.design.text || "left";

		modParams.title = modParams.title || {};
		...
		modParams.title.text = modParams.title.text || modParams.title.$data.text;
		modParams.title.href = modParams.title.href || modParams.title.$data.href;

		modParams.multiText_desc = modParams.multiText_desc || {};
		modParams.multiText_desc.$data = {
			is_leaf      : true,
			type         : "multiText",
			editable     : true,
			is_card_show : true,
		...
		modParams.multiText_desc.text = modParams.multiText_desc.text || modParams.multiText_desc.$data.text;
		modParams.multiText_desc.href = modParams.multiText_desc.href || modParams.multiText_desc.$data.href;
		return modParams;
	}
