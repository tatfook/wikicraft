...
define([], function () {
    ...
    var translations = [
        ...
        },
        {
            "_key": "360浏览器",
            "zh-cn": "360浏览器",
            "en": "360 browser (360浏览器由奇虎360公司出品 ,被称为安全的浏览器.)"
        },
        {
            "_key": "联系我们",
            "zh-cn": "联系我们",
        ...
        },
        {
            "_key": "请输入网络地址：",
            "zh-cn": "请输入网络地址：",
            "en": "Please enter the network address:"
        },
        {
            "_key": "确定",
            "zh-cn": "确定",
        ...
        },
        {
            ...
            "en": "By default, most people can be allowed to access. Even if they are not logged in, they can set edit rights for some people, make them become administrators of participating editors, and set up refusal permission for some people, then join them in the blacklist."
        },
        {
            "_key": "私有项目",
            "zh-cn": "私有项目",
        ...
        },
        {
            ...
            "en": "The default is not allowed to browse the unlogged user. It can set edit privileges for some people, make them become administrators of participating editors, set up browsing privileges for some people, they can browse the content you create, and other unauthorized users can't browse."
        },
        {
            "_key": "授权管理",
            "zh-cn": "授权管理",
        ...
        },
        {
            "_key": "* 分组名称仅支持英文、数字",
            "zh-cn": "* 分组名称仅支持英文、数字",
            "en": "* group name only support English, number"
        },
        {
            "_key": "分组成员：",
            "zh-cn": "分组成员：",
        ...
        },
        {
            ...
            "en": "KeepWork is an integration of many creative tools personal works creation and sharing platform. Students, teachers, the enterprise can make website with it, 3D animation and application software; and learning together with tens of thousands of users and creation. We are committed to development of free and easy to use personal creation tools and provide lasting and reliable data storage services."
        },
        {
            "_key": "登录账号",
            "zh-cn": "登录账号",
        ...
        },
        {
            "_key": "很抱歉！您访问的页面不存在...",
            "zh-cn": "很抱歉！您访问的页面不存在...",
            "en": "I'm sorry! The pages you visited did not exist..."
        },
        {
            "_key": "创建该页面",
            "zh-cn": "创建该页面",
        ...
        },
        {
            "_key": "注册新账号",
            "zh-cn": "注册新账号",
            "en": "Registration of new accounts"
        },
        {
            "_key": "账号密码登录",
            "zh-cn": "账号密码登录",
        ...
        },
        {
            "_key": "首次使用请下载手机支付宝",
            "zh-cn": "首次使用请下载手机支付宝",
            "en": "Please download the Alipay mobile phone for the first time"
        },
        {
            "_key": "5秒钟后将返回...",
            "zh-cn": "5秒钟后将返回...",
        ...
        },
        {
            "_key": "个人简介字数超过限制。",
            "zh-cn": "个人简介字数超过限制。",
            "en": "The number of personal profiles exceeds the limit."
        },
        {
            "_key": "保 存",
            "zh-cn": "保 存",
